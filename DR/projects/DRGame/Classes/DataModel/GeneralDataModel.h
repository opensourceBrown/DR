...
//定义关卡结构
typedef struct{
    unsigned int             mID;					//�ؿ�id

	float					mCommMosterRate;		//��ͨ�ֳ��ֵĸ���
	float					mCoinRate;			//��ҳ��ֵĸ���
	float					mPotionRate;			//Ѫƿ���ֵĸ���
	float					mBossMosterRate;		//boss�ֳ��ֵĸ���
	float					mShieldRate;			//�ܳ��ֵĸ���
	unsigned int				mPassCondID;			//�ؿ�ͨ��������id
}GameStageProperty;
