...
typedef enum{
    ...
    kBossBustyType_Poisonous,       //每次攻击会使Player的状态变成毒。毒的效果是让Player每一回合受到最大生命之的１０％的伤害。无法被盾抵抗。效果持续５回合。
    ...
    kBossBustyType_Freezing,        //随机把自己周围的２个block解冻。被解冻的block无法被消除。每一回合被解冻的block都会重新判断。
